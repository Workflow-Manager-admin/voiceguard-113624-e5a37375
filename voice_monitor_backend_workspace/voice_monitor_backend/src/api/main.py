...
@app.get("/")
def health_check():
    """Health check endpoint. Returns {"message": "Healthy"} if server is up."""
...
async def test_voice(
    ...
    - Returns: List of dicts with user_id and similarity_score, ranked best match first.
    ...
    return JSONResponse(
        content={
            ...
            "detail": (
                "Tested against all enrolled voices. Higher score = closer match."
            ),
        },
